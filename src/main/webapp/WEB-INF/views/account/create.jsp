						...
						<input type="hidden" name="productNum" value="${param.productNum}">
							<div class="form-group">
								<label for="password">Password</label> <input type="password"
									name="accountpw" class="form-control" id="accountpw">
							</div>

							<div class="form-group">
								<label for="accountpwCheck">Password</label> <input type="password"
									name="accountpwCheck" class="form-control" id="accountpwCheck">
							</div>
